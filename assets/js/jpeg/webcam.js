...
window.webcam = {
	...
	get_html: function(width, height, server_width, server_height) {
		...
		if (!server_width) server_width = width-20;
		if (!server_height) server_height = height-20;
		width = width-20;
                height = height-40;
		...
		if (this.ie) {
			...
			html += '<embed id="webcam_movie" src="'+this.swf_url+'" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="'+(width-20)+'" height="'+height+'" name="webcam_movie" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" />';
		}
