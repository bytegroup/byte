...
<div class='ui-widget-content ui-corner-all datatables'>
	<h3 class="ui-accordion-header ui-helper-reset ui-state-default form-title">
		...
		<div class='floatR'>
			<a href='<?php echo $list_url?>' onclick='javascript: return goToList()' class='btn' >
		...
		<div class='buttons-box'>
			<div class='form-button-box'>
				<button type='submit' class='btn btn-primary'>
                                     <i class="icon-edit icon-white"></i> <?php echo $this->l('form_update_changes'); ?>
                                </button>
			</div>		
			<div class='form-button-box'>
				<button type='button'  onclick='javascript: return goToList()' class='btn btn-primary' >
                                    <i class="icon-remove icon-white"></i> <?php echo $this->l('form_cancel'); ?>
                                </button>
			</div>
