...
class Purchase_List_Model extends CI_Model {
    ...
    private function _data_with_filter($filters){
        ...
        $this->db->select('c.companyName, rec.receiveId, rec.receiveNumber, rec.receiveDate, r.requisitionNumber, r.requisitionCreateDate, r.requisitionTitle, q.quotationNumber, q.quotationDate, v.vendorsName, b.billAmount, b.billNumber,  creator.firstName cFirstName, creator.middleName cMiddleName, creator.lastName cLastName, editor.firstName eFirstName, editor.middleName eMiddleName, editor.lastName eLastName, rec.createDate, rec.editDate');
