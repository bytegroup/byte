...
<div class="" style="width: auto; height: auto; border: 0px #999 solid; float: right">
    <div class="form-button-box">
        <input type="button" value="Back to Quotation List" onclick="window.location='<?php echo $backToList; ?>'" class="ui-input-button" id="">
    </div>
</div>
...
<script language="JavaScript">
    $(document).ready(function(e){
        ...
        $('div.DTTT_container a#excelDownload').click(function(){
            window.location= '<?php echo base_url(REPORT_FOLDER.'quotation_details/get_excel/'.$quotationId);?>';
        });
    });
