...
<script language="JavaScript">
    $(document).ready(function(e){
        ...
        $('div.DTTT_container a#excelDownload').click(function(){
            $('form#filter-form')
                .attr('action', baseURL+'current_issue/get_excel')
                .attr('method', 'post')
                .attr('target', '_blank')
                .submit();
        });
        ...
        $('#filter-button').click(function(){
            filterDataTable(baseURL+'current_issue/ajax_get_data', filterDT);
        });

        $('#company').change(function(){
            get_dependent_options('company', 'department', baseURL+'current_issue/ajax_get_department/');
        });
        $('#category').change(function(){
            get_dependent_options('category', 'item', baseURL+'current_issue/ajax_get_items/');
        });
