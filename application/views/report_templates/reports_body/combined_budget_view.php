...
<table id="report-table" class="display" width="100%" cellspacing="0">
    ...
    <tr>
        <th colspan="3">&nbsp;</th>
        <th colspan="3">Budgeted Amount</th>
        <th colspan="3">Budget Utilization</th>
        <th colspan="3">Remaining Budget</th>
    </tr>
    <tr>
...
<script language="JavaScript">
    $(document).ready(function(e){
        ...
        $('div.DTTT_container a#excelDownload').click(function(){
            $('form#filter-form')
                .attr('action', baseURL+'combined_budget/get_excel')
                .attr('method', 'post')
                .attr('target', '_blank')
                .submit();
        });
        ...
        $('#filter-button').click(function(){
            filterDataTable(baseURL+'combined_budget/ajax_get_data', filterDT);
        });

        $('#company').change(function(){
            get_dependent_options('company', 'budget_head', baseURL+'combined_budget/ajax_get_budget_head/');
        });
