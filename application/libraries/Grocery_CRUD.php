...
class Grocery_CRUD extends grocery_CRUD_States
{
    ...
    protected $callback_boolean         = false;
...
//@todo ui_day, ui_month, ui_year has to be lang strings
    ...
    /******************************************************************/
    public function callback_boolean($callback = null)
    {
        $this->callback_boolean = $callback;
