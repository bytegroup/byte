...
class Current_Issue extends MX_Controller {
    function __construct(){
        ...
        /* ------------------ */
        $this->load->model(REPORT_MODELS.'current_issue_model', 'model');
    ...
    function index(){
        try{
            ...
            $output['pageTitle'] = "Current Issue Stock";
            $output['base_url'] = base_url();
            $output['body_template'] = "current_issue_view.php";
    ...
    function get_excel(){
        ...
        $sheet->setTitle('Current Issue Stock');
        ...
        $sheet->setCellValue('A1', 'Current Issue Stock');
        ...
        $filename='current_issue_stock.xlsx';
