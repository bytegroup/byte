...
class Stock_Report extends MX_Controller {
    ...
    function index(){
        try{
            ...
            $output['headers']= $this->get_headers();
    ...
    function get_excel(){
        ...
        $this->excel->getProperties()
            ->setCreator($this->my_session->userName)
        ...
        $this->excel->set_table($sheet, $this->get_headers(), $this->model->get_data(), $sheet->getHighestRow());
