...
class Product_Details extends MX_Controller {
    function __construct(){
        ...
        /* ------------------ */
        $this->load->model(REPORT_MODELS.'product_details_model', 'model');
    ...
    function index(){
        try{
            ...
            $output['pageTitle'] = "Product Details Report";
            $output['base_url'] = base_url();
            $output['body_template'] = "product_details_view.php";
    ...
    function get_excel(){
        ...
        $sheet->setTitle('Product Details Report');
        ...
        $sheet->setCellValue('A1', 'Product Details Report');
        ...
        $filename='product_details_report.xlsx';
