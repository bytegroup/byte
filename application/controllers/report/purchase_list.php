...
class Purchase_List extends MX_Controller {
    function __construct(){
        ...
        /* ------------------ */
        $this->load->model(REPORT_MODELS.'purchase_list_model', 'model');
    ...
    function get_excel(){
        ...
        $sheet->setCellValue('A1', 'Purchase List');
