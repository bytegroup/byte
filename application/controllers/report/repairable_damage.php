...
class Repairable_Damage extends MX_Controller {
    function __construct(){
        ...
        /* ------------------ */
        $this->load->model(REPORT_MODELS.'repairable_damage_model', 'model');
    ...
    function index(){
        try{
            ...
            $output['pageTitle'] = "Issue Report";
            $output['base_url'] = base_url();
            $output['body_template'] = "repairable_damage_view.php";
    ...
    function get_excel(){
        ...
        $sheet->setTitle('Repairable Damage');
        ...
        $sheet->setCellValue('A1', 'Repairable Damaged Product List');
        ...
        $filename='repairable_damage.xlsx';
