...
class Issue_Report extends MX_Controller {
    function __construct(){
        ...
        /* ------------------ */
        $this->load->model(REPORT_MODELS.'issue_report_model', 'model');
    ...
    function index(){
        try{
            ...
            $output['body_template'] = "issue_report_view.php";
    ...
    function get_excel(){
        ...
        $sheet->setCellValue('A1', 'Issue Report');
