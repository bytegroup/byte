...
class Disposal_Damage extends MX_Controller {
    function __construct(){
        ...
        /* ------------------ */
        $this->load->model(REPORT_MODELS.'disposal_damage_model', 'model');
    ...
    function index(){
        try{
            ...
            $output['body_template'] = "disposal_damage_view.php";
    ...
    function get_excel(){
        ...
        $sheet->setTitle('Disposal Damage');
        ...
        $sheet->setCellValue('A1', 'List of Disposal Damage Product');
