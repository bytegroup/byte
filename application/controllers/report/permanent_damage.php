...
class Permanent_Damage extends MX_Controller {
    function __construct(){
        ...
        /* ------------------ */
        $this->load->model(REPORT_MODELS.'permanent_damage_model', 'model');
    ...
    function index(){
        try{
            ...
            $output['body_template'] = "permanent_damage_view.php";
    ...
    function get_excel(){
        ...
        $sheet->setTitle('Permanent Damage');
        ...
        $sheet->setCellValue('A1', 'Permanent Damaged Product List');
        ...
        $filename='permanent_damage.xlsx';
