...
class Combined_Budget extends MX_Controller {
    ...
    function index(){
        try{
            ...
            $output['pageTitle'] = "Combined Budget Utilization";
            $output['base_url'] = base_url();
            $output['body_template'] = "combined_budget_view.php";
    ...
    function get_excel(){
        ...
        $sheet->setTitle('Combined Budget');
        ...
        $sheet->setCellValue('A1', 'Combined Budget Utilization');
